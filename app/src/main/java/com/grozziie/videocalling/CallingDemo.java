...
public class CallingDemo extends AppCompatActivity {
    ...
    private final String appId = "ea3626ac5c004b65a6f555c6e73b3199";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calling_demo);
        if (!checkSelfPermission()) {
            ActivityCompat.requestPermissions(this, REQUESTED_PERMISSIONS, PERMISSION_REQ_ID);
        }
        String appSign =appId;
        String userID =appId ;
        String userName = appSign;
        String roomID = appId;
        String roomname = appSign;
